...
| `scenes/<id>.json` | scene claim: `{scene, status: claimed|open|accepted, by, since}`; `board.py claim-scene / release-scene / scenes` | studio instances |
...
python tools/board/board.py claim-scene harbour --by lead-1   # an instance takes a scene nobody else holds
